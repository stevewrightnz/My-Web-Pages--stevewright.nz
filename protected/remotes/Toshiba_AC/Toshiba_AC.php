...
<link rel="stylesheet" type="text/css" href="https://stevewright.nz/protected/remotes/Toshiba_AC/Toshiba_AC.css">
...
<div class="screen">
	...
	<div class="scr-middle">
		<div class="space-even">
			<div id="tempdeg">
				<div id="temp"><input type='text' name='quantity' value='20' class='tempno' maxlength='2'/></div>
			</div>
			<div></div>
