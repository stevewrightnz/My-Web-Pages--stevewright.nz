...
<?php include("includes/header.php")?>
	...
	<main class="site-content">
		...
		<ul>
			...
			<li>Gigabit Network adapter - GIGA-BYTE TECHNOLOGY CO.,LTD. </li>
			</ul>
			<li>Gigabit wired Ethernet connection running through a Vodafone Technicolor broadband modem.</li>
			<li>Vodafone issue HG659 Router </li>
			<!--<li>Tenda switch.</li>-->
			<li>CAT 6 Cabling.</li>
		</ul>
		...
		<p><b>17 April 2017</b> - Downer Technician analysed Vodafone network - determined there was a fault in the street 
